...
PointLightSystem::PointLightSystem(Device& init_device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout)
    : device{ init_device } {
...
void PointLightSystem::update(FrameInfo& frameInfo, GlobalUbo& ubo) {
    //auto rotateLight = glm::rotate(glm::mat4(1.f), frameInfo.frameTime / 15, { 0.f, -1.f, 0.f }); //
	int lightIndex = 0;
